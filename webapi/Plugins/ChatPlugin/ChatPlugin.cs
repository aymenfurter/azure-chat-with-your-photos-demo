...
public class ChatPlugin
{
        ...
        IOptions<PictureMemoryOptions> documentImportOptions)
    {
        ...
        this._pictureMemorySkill = new PictureMemoryPlugin(promptOptions, documentImportOptions);
        this._intentProcessor = new UserIntentProcessor(this._promptOptions, kernel);
        this._contextProcessor = new ChatContextProcessor(this._promptOptions, this._pictureMemorySkill, kernel);
    ...
    private void UpdateContextVariables(SKContext chatContext, string response)
    {
        ...
        List<string> pictureLinks = ChatPluginUtilities.ExtractLinks(response, chatContextValue);
        var result = ChatPluginUtilities.ReplaceLinks(response, pictureLinks);
