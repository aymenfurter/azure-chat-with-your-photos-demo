...
using AzureChatWithPhotos.Connectors.Memory.AzureCognitiveSearchVector;
...
namespace AzureChatWithPhotos.Plugins.ChatPlugins
{
    public class PictureMemoryPlugin
    {
        ...
        private readonly AISearchMemoryClient _azureCognitiveSearchMemory;
            ...
            IOptions<PictureMemoryOptions> pictureImportOptions)
        {
            ...
            _azureCognitiveSearchMemory = new AISearchMemoryClient(searchEndpoint, acsApiKey, client);
        }
        ...
        public async Task<string> QueryPictureVideosAsync([Description("Query to match.")] string query, SKContext context, SortPlugin.SortType sortType)
        {
